...
public class NewArrivalKitchenFragment extends Fragment {
    ...
    private Integer image1[]={R.drawable.ac,R.drawable.kitchenboxes,R.drawable.ac,R.drawable.kitchenboxes,R.drawable.ac,R.drawable.kitchenboxes,R.drawable.ac,R.drawable.kitchenboxes,};
    private String title1[] ={"Vigo Atom Personal Air Condi....","Bosh Head Phone Blue Color","Vigo Atom Personal Air Condi....","Bosh Head Phone Blue Color","Vigo Atom Personal Air Condi....","Bosh Head Phone Blue Color","Vigo Atom Personal Air Condi....","Bosh Head Phone Blue Color"};
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        for (int i = 0; i < image1.length; i++) {
            NewArrivalKitchenModellClass beanClassForRecyclerView_contacts = new NewArrivalKitchenModellClass(image1[i],title1[i]);
