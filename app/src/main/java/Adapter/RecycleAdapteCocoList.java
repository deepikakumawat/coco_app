...
import com.ws.design.coco_ecommerce_ui_kit.ExploreFragment;
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (position == 0) {
                    ...
                    Intent i = new Intent(context, DepartmentFragment.class);
                    context.startActivity(i);
                } else if (position == 4) {
                    ...
                    Intent i = new Intent(context, CheckoutFragment.class);
                    context.startActivity(i);
                }else if (position == 20) {
...
//                    context.startActivity(i);
                    ...
                    Intent i = new Intent(context, ProductByCategoryActivity1.class);
                    context.startActivity(i);
                } else if (position == 33) {
