...
public class StartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtGotoHome.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void launchHomeScreen() {
        CocoPreferences.setFirstTimeLaunch(false);
...
//                btnNext.setText(getString(R.string.start));
                txtGotoHome.setText("SKIP INTRO");
                launchHomeScreen();
//                txtGotoHome.setVisibility(View.GONE);
            } else {
