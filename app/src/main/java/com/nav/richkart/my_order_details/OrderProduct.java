...
public class OrderProduct {
    ...
    @Expose
    private String getmModifiedDate;
    ...
    @Expose
    private String mProductDetailsShortDetails;
    ...
    public void setmItemOrderId(String mItemOrderId) {
        this.mItemOrderId = mItemOrderId;
    }
    ...
    public String getGetmModifiedDate() {
        return getmModifiedDate;
    }

    public void setGetmModifiedDate(String getmModifiedDate) {
        this.getmModifiedDate = getmModifiedDate;
    }
    ...
    public String getmProdcutName() {
        return mProdcutName;
    }

    public void setmProdcutName(String mProdcutName) {
        this.mProdcutName = mProdcutName;
    }
    ...
    public String getmProductDetailsShortDetails() {
        return mProductDetailsShortDetails;
    }

    public void setmProductDetailsShortDetails(String mProductDetailsShortDetails) {
        this.mProductDetailsShortDetails = mProductDetailsShortDetails;
    }
