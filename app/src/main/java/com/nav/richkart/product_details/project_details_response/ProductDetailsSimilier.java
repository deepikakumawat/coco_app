package com.nav.richkart.product_details.project_details_response;
...
public class ProductDetailsSimilier {
    ...
    @Expose
    private String mProdcutBrought;

    @SerializedName("productnote")
    @Expose
    private String mProdcutNote;
    ...
    public String getmProdcutBrought() {
        return mProdcutBrought;
    }

    public void setmProdcutBrought(String mProdcutBrought) {
        this.mProdcutBrought = mProdcutBrought;
    }

    public String getmProdcutNote() {
        return mProdcutNote;
    }

    public void setmProdcutNote(String mProdcutNote) {
        this.mProdcutNote = mProdcutNote;
    }
