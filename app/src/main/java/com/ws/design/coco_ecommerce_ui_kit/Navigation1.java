...
public class Navigation1 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private String title[] = {"Cart","My Orders","Categories","Trandings",
            "Offers","Profile","Help"};
...
/*
        mAdapter = new RecycleAdapteNavigation(Navigation1.this,navigationModelClasses);

        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(Navigation1.this);
