...
public class CocoCart1Activity extends AppCompatActivity implements CartView, View.OnClickListener {
    ...
    public void getCartList(CartListResponse cartListResponse) {
        if (cartListResponse != null) {
            if (!cartListResponse.getmCartlistData().getmProductData().isEmpty()) {
                ...
                cartListAdapter = new CartListAdapter1(this, productDataArrayList, CocoCart1Activity.this);
