...
//            ((LinearLayout) root).setDividerDrawable(drawable);
            ...
            final ViewPager viewPager1 = (ViewPager) mView.findViewById(R.id.pager);
            CategoryPagerAdapterExplor adapter = new CategoryPagerAdapterExplor(getActivity().getSupportFragmentManager(), 5);
