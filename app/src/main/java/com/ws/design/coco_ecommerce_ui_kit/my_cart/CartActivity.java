...
//    private RecycleAdapterCocoCart1 bAdapter;
    ...
    /*    navigationModelClasses = new ArrayList<>();
        ...
        mAdapter = new RecycleAdapterCocoCart0(CartActivity.this, navigationModelClasses);*/
...
//
//
//        bAdapter = new RecycleAdapterCocoCart1(CartActivity.this,navigationModelClasses1);
//
//        RecyclerView.LayoutManager bLayoutManager = new LinearLayoutManager(CartActivity.this);
...
//        recyclerView1.setAdapter(bAdapter);
     ...
     /*   recyclerView2 = (RecyclerView) findViewById(R.id.recycler3);
      ...
      /*  cAdapter = new RecycleAdapterCocoCart2(CartActivity.this,navigationModelClasses2);

        RecyclerView.LayoutManager cLayoutManager = new LinearLayoutManager(CartActivity.this);
