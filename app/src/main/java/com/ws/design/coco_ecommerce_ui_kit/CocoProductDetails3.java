...
import Adapter.Details3TabAdapter;

public class CocoProductDetails3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coco_product_details3);
...
//        }
        ...
        Details3TabAdapter adapter = new Details3TabAdapter(getSupportFragmentManager(), 3);
