...
public class ShipmentListAdapter extends RecyclerView.Adapter<ShipmentListAdapter.ViewHolder> implements View.OnClickListener {
    private Context context;
    private ArrayList<CartListResponse.ProductData> productDataArrayList;
    private ShippingFragment shippingFragment;


    public ShipmentListAdapter(Context context, ArrayList<CartListResponse.ProductData> productDataArrayList, ShippingFragment shippingFragment) {
